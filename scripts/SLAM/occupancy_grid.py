...
class OccupancyGrid:
    ...
    def itemizeSpokesGrid(self, xGrid, yGrid, bearingIdxGrid, rangeIdxGrid):
        """
        Creates lists of x, y, and range values for each ray in the grid.
        These values are used later to update the occupancy grid to cover the entire field of view of the lidar sensor
        """
